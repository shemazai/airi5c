...
//
parameter   RNG_TYPE        = RAIFES_COP_RNG_TYPE_LFSR32;
...
wire is_rseed   = rng_ivalid && id_subclass[RAIFES_COP_SCLASS_RSEED];

wire is_rsamp   = rng_ivalid && id_subclass[RAIFES_COP_SCLASS_RSAMP];

wire is_rtest   = rng_ivalid && id_subclass[RAIFES_COP_SCLASS_RTEST];
...
generate if(RNG_TYPE == RAIFES_COP_RNG_TYPE_LFSR32) begin : gen_lfsr32
