...
# Generated on: Sat Oct 20 10:53:37 CEST 2018 (Sat Oct 20 08:53:37 GMT 2018)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/permut_sel/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/permut_sel -revised fv_map
...
elaborate_design -golden -root {permut_sel} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/permut_sel/fv_map.v.gz
elaborate_design -revised -root {permut_sel}
...
#add_name_alias fv/permut_sel/fv_map.singlebit.original_name.alias.json.gz -revised
