...
# Generated on: Thu Nov 15 10:54:49 CET 2018 (Thu Nov 15 09:54:49 GMT 2018)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/raifes_dtm/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/raifes_dtm -revised fv_map
...
add_search_path /Abteilungen/ISS/ISS-ALL/unix/cad/RISCV/local/riscv-flavor/trunk/flavor/src/modules/raifes_dtm/src -design -golden
read_design   -define SYNTHESIS -keep_unreach -merge bbox -golden -lastmod -noelab -verilog2k /Abteilungen/ISS/ISS-ALL/unix/cad/RISCV/local/riscv-flavor/trunk/flavor/src/modules/raifes_dtm/src/raifes_dtm.v
elaborate_design -golden -root {raifes_dtm} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/raifes_dtm/fv_map.v.gz
elaborate_design -revised -root {raifes_dtm}
...
#add_name_alias fv/raifes_dtm/fv_map.singlebit.original_name.alias.json.gz -revised
