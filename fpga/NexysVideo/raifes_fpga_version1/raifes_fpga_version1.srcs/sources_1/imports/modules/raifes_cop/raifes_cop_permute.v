...
wire is_pbit    = perm_ivalid && id_subclass[RAIFES_COP_SCLASS_PERM_BIT];
wire is_ipbit   = perm_ivalid && id_subclass[RAIFES_COP_SCLASS_PERM_IBIT];
wire is_pbyte   = perm_ivalid && id_subclass[RAIFES_COP_SCLASS_PERM_BYTE];
