...
assign	pcpi_wr = pcpi_ready_mul_div ? pcpi_wr_mul_div : 
                  pcpi_wr_cop ? pcpi_wr_cop : 1'b0;

assign	pcpi_rd = pcpi_ready_mul_div ? pcpi_rd_mul_div : 
                  pcpi_ready_cop ? pcpi_rd_cop : 
                  32'hdeadbeef;
assign	pcpi_wait = pcpi_wait_mul_div | pcpi_wait_cop;
assign	pcpi_ready =  pcpi_ready_mul_div | pcpi_ready_cop;
