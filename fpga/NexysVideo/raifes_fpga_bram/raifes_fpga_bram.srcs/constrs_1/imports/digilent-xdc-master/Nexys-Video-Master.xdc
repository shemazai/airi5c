...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[12]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[16]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[18]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[32]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[52]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[13]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[33]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[34]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[53]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[58]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/xor_in1[19]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/xor_out_middle[14]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[15]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[17]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/sbox_inv_in[59]];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets theCryptoModule/Prince_cipher/xor_in1[31]];
...
set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { TMS }]; #IO_L10P_T1_D14_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { TDI }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { TDO }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
