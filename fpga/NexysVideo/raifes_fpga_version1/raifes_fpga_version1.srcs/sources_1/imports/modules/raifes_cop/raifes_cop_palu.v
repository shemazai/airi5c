...
input  wire [ 6:0]  id_class         , // Instruction class
...
wire is_mov_insn  = 
    palu_ivalid && id_class[RAIFES_COP_ICLASS_MOVE];

wire is_bitwise_insn = 
    palu_ivalid && id_class[RAIFES_COP_ICLASS_BITWISE];

wire is_parith_insn = 
    palu_ivalid && id_class[RAIFES_COP_ICLASS_PACKED_ARITH];
...
wire  is_cmov_t  = is_mov_insn && id_subclass[RAIFES_COP_SCLASS_CMOV_T ];
wire  is_cmov_f  = is_mov_insn && id_subclass[RAIFES_COP_SCLASS_CMOV_F ];
wire  is_gpr2xcr = is_mov_insn && id_subclass[RAIFES_COP_SCLASS_GPR2XCR];
...
wire bw_bop    = is_bitwise_insn && id_subclass[RAIFES_COP_SCLASS_BOP   ];
wire bw_bmv    = is_bitwise_insn && id_subclass[RAIFES_COP_SCLASS_BMV   ]; 
wire bw_ins    = is_bitwise_insn && id_subclass[RAIFES_COP_SCLASS_INS   ]; 
wire bw_ext    = is_bitwise_insn && id_subclass[RAIFES_COP_SCLASS_EXT   ];
wire bw_ld_liu = is_bitwise_insn && id_subclass[RAIFES_COP_SCLASS_LD_LIU];
wire bw_ld_hiu = is_bitwise_insn && id_subclass[RAIFES_COP_SCLASS_LD_HIU];
wire bw_lut    = is_bitwise_insn && id_subclass[RAIFES_COP_SCLASS_LUT   ];
...
wire is_padd    = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PADD];
wire is_psub    = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PSUB];
wire is_pmul_l  = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PMUL_L];
wire is_pmul_h  = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PMUL_H];
wire is_pclmul_l= is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PCLMUL_L];
wire is_pclmul_h= is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PCLMUL_H];
wire is_psll    = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PSLL];
wire is_psrl    = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PSRL];
wire is_prot    = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PROT];
wire is_psll_i  = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PSLL_I];
wire is_psrl_i  = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PSRL_I];
wire is_prot_i  = is_parith_insn && id_subclass[RAIFES_COP_SCLASS_PROT_I];
