...
# Generated on: Thu Nov 08 10:50:18 CET 2018 (Thu Nov 08 09:50:18 GMT 2018)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/__default_mmmc_spec/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/__default_mmmc_spec -revised fv_map
...
read_design -verilog95   -revised -lastmod -noelab fv/__default_mmmc_spec/fv_map.v.gz
elaborate_design -revised -root {__default_mmmc_spec}
